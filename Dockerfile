...
RUN /opt/android-sdk-linux/tools/bin/sdkmanager "platforms;android-22"

RUN /opt/android-sdk-linux/tools/bin/sdkmanager "platform-tools"

RUN /opt/android-sdk-linux/tools/bin/sdkmanager "emulator"

RUN /opt/android-sdk-linux/tools/bin/sdkmanager "system-images;android-22;google_apis;x86_64"
